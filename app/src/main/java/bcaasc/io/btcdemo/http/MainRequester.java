...
public class MainRequester {
     ...
     * @param callBackListener
     */
    public void creatPushTX(RequestBody body, Callback<String> callBackListener) {
        HttpApi httpApi = RetrofitFactory.getInstance().create(HttpApi.class);
        Call<String> call = httpApi.createPushTx(body, true);
        call.enqueue(callBackListener);
    }
     ...
     * @param callBackListener
     */
    public void sendTX(RequestBody rawHash, Callback<String> callBackListener) {
        HttpApi httpApi = RetrofitFactory.getInstance().create(HttpApi.class);
        Call<String> call = httpApi.sendTX(rawHash);
        call.enqueue(callBackListener);
    }
